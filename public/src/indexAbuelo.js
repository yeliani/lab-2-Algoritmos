	...
	render() {
		this.shadowRoot.innerHTML = `
			...
			<section class= "sect-banner2">
				...
				<div class= "text-content"><bannertwo-component></bannertwo-component></div>
				<btn-component id="btn" color="#FF0D78" label="JOIN NOW"></btn-component>
             </section>
